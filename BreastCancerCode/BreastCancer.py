...
def load_dataset(testNum=numOfTestPoints):
    ...
    train_set_x_orig, train_set_y_orig, cnt = get_imgs_frm_folder(r'C:\Users\saira\Cancer-detection-using-CNN\X_train.npy')
    ...
    classes = np.array(os.listdir('C:\\Users\\saira\\Cancer-detection-using-CNN\\X_train.npy'))  # the list of classes
